(() => {
    ...
    const features = {
        ...
        members: {
            ...
            styles: ['/css/pages/members.css?v=attendance-compact', '/css/pages/memberships.css?v=phase2', '/css/pages/attendance.css?v=attendance-ui-v4'],
        ...
        attendance: { dependencies: ['phone-inputs'], styles: ['/css/pages/attendance.css?v=attendance-ui-v4'], scripts: ['/js/pages/attendance/attendance.js?v=attendance-compact'] },
