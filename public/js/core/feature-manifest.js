(() => {
    ...
    const features = {
        ...
        'dashboard-enhancements': { dependencies: ['finance'], styles: [], scripts: ['/js/day-passes.js?v=8', '/js/alerts-enhancements.js?v=10'] },
        finance: { dependencies: [], styles: [], scripts: ['/js/pages/finance/monthly-finance.js?v=20'] },
        'member-details': { dependencies: [], styles: [], scripts: ['/js/member-details-ui.js?v=6', '/js/member-portal-admin.js?v=4', '/js/member-coaching-summary.js?v=2'] },
        members: {
            dependencies: [],
            styles: ['/css/pages/members.css?v=phase2', '/css/pages/memberships.css?v=phase2', '/css/pages/attendance.css?v=phase2'],
            scripts: ['/js/design-enhancements.js?v=4', '/js/pages/members/action-menu.js?v=7', '/js/pagination.js?v=2', '/js/pages/attendance/attendance.js?v=10']
        },
        coaching: { dependencies: [], dialogs: [{ source: '/dialogs/coaching.html?v=phase4', ids: ['externalTraineeDialog', 'coachingProfileDialog', 'coachingBuilderDialog'] }], styles: [], scripts: ['/js/exercise-assets.js?v=5', '/js/muscle-assets.js?v=3', '/js/pages/coaching/coaching.js?v=19'] },
        print: { dependencies: [], styles: [], scripts: ['/js/exercise-assets.js?v=5', '/js/integrations/print-enhancements.js?v=14'] },
        expenses: { dependencies: ['finance'], styles: ['/css/pages/expenses.css?v=phase2'], scripts: [] },
        reports: { dependencies: [], styles: ['/css/pages/reports.css?v=phase2'], scripts: ['/js/pages/reports/reports.js?v=10', '/js/day-pass-reports.js?v=2'] },
        feedback: { dependencies: [], styles: ['/css/pages/member-feedback.css?v=phase2'], scripts: ['/js/pages/management/member-feedback.js?v=1'] },
        ...
        attendance: { dependencies: [], styles: ['/css/pages/attendance.css?v=phase2'], scripts: ['/js/pages/attendance/attendance.js?v=10'] },
        ...
        intelligence: { dependencies: [], styles: ['/css/pages/intelligence.css?v=phase2'], scripts: ['/js/pages/intelligence/intelligence.js?v=3'] },
        store: { dependencies: [], styles: ['/css/pages/store.css?v=phase2', '/css/components/bar-pos.css?v=phase2'], scripts: ['/js/pages/store/store.js?v=1', '/js/pages/store/bar-pos.js?v=1'] },
        'smart-assistant': { dependencies: [], styles: [], scripts: ['/js/smart-assistant.js?v=5'] },
        'phone-inputs': { dependencies: [], styles: [], scripts: ['/js/core/phone-inputs.js?v=9'] }
    };
