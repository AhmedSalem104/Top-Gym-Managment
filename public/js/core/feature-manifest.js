(() => {
    ...
    const features = {
        ...
        'dashboard-enhancements': { dependencies: ['finance', 'phone-inputs'], styles: [], scripts: ['/js/day-passes.js?v=8', '/js/alerts-enhancements.js?v=10'] },
        ...
        reports: { dependencies: ['phone-inputs'], styles: ['/css/pages/reports.css?v=phase2'], scripts: ['/js/pages/reports/reports.js?v=10', '/js/day-pass-reports.js?v=2'] },
        ...
        attendance: { dependencies: ['phone-inputs'], styles: ['/css/pages/attendance.css?v=phase2'], scripts: ['/js/pages/attendance/attendance.js?v=10'] },
        ...
        'phone-inputs': { dependencies: [], styles: [], scripts: ['/js/core/phone-inputs.js?v=10'] }
    };
