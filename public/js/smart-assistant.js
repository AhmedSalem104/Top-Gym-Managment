(() => {
    ...
    const SCREEN_META = Object.freeze({
        ...
        'backup-history': {
            ...
            help: 'من شاشة حماية البيانات يمكنك تنزيل نسخة .json.gz، فحص ملف قبل الاسترجاع، ومراجعة النسخ المحفوظة وسجل العمليات. هذه الأدوات مخصصة للOwner.',
            actions: []
        },
        attendance: {
            tab: 'attendance',
    ...
    const ACTIONS = Object.freeze({
        ...
        'add-member': { label: 'إضافة مشترك', icon: 'plus', type: 'navigate-click', tab: 'members', selector: '#addMemberButton', permission: 'members.create', success: 'فتحت نافذة إضافة مشترك.' },
        ...
        'search-members': { label: 'البحث عن مشترك', icon: 'search', type: 'focus', selector: '#searchInput', permission: 'members.read,memberships.read', success: 'يمكنك كتابة اسم المشترك أو رقم الهاتف الآن.' },
        ...
        'create-workout': { label: 'إنشاء خطة تدريب', icon: 'dumbbell', type: 'navigate-click', tab: 'trainees', selector: '[data-coaching-action="workout"]', permission: 'coaching.create,coaching.read', success: 'اختر المتدرب لإنشاء خطة التدريب.' },
        'create-diet': { label: 'إنشاء خطة تغذية', icon: 'heart', type: 'navigate-click', tab: 'trainees', selector: '[data-coaching-action="diet"]', permission: 'coaching.create,coaching.read', success: 'اختر المتدرب لإنشاء خطة التغذية.' },
