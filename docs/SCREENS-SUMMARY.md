...
| `#management` | الأسعار والعضويات والإدارة | نعم | لا |
...
- إضافة Assistant.
- تعديل البيانات.
- تفعيل/تعطيل Assistant.
- لا يسمح بتعطيل Owner من نفس القواعد الحالية.
