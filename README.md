...
> ملاحظة: المشروع لا يحتوي على نظام تسجيل دخول في النسخة الحالية. لا تفتحه للعامة قبل إضافة المصادقة والصلاحيات أو وضعه خلف شبكة خاصة.

## نظرة سريعة

يحتوي التطبيق على أربع مناطق رئيسية:
...
- لا توجد مصادقة أو أدوار مستخدمين حاليًا.
- لا يوجد scheduler داخلي للنسخ اليومية أو retention تلقائي.
- قبل النشر العام أضف login، صلاحيات، حماية CSRF عند الحاجة، rate limiting، وسجل تدقيق للإدارة.
