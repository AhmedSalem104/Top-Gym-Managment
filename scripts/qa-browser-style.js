...
const screenIds = ['dashboardSection', 'membersSection', 'traineesSection', 'managementSection', 'backupHistorySection', 'attendanceSection', 'expensesSection', 'librarySection', 'reportsSection', 'brandingSection', 'permissionsSection', 'intelligenceSection', 'feedbackSection', 'storeSection', 'memberSubscriptionRequestsSection', 'portalAnalyticsSection'];
