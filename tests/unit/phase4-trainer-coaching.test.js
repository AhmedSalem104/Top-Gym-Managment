...
test('Trainer routes are isolated by persisted tenant type and use existing auth context', () => {
    ...
    assert.match(routeIndex, /registerTrainerRoutes\(app, \{ trainerService, trainerCommerceService, trainerStudioService, libraryService, intelligenceService, asyncRoute \}\)/);
