...
test('phone input layer is loaded by every page that owns a phone form', () => {
    ...
    assert.match(read('public/js/core/feature-manifest.js'), /core\/phone-inputs\.js\?v=12/);
    assert.match(read('public/js/feature-loader.js'), /bindLazyPhoneInput/);
    assert.match(read('public/register-gym.html'), /core\/phone-inputs\.js\?v=12/);
    assert.match(read('public/register-trainer.html'), /core\/phone-inputs\.js\?v=12/);
    assert.match(read('public/trainer-workspace.html'), /core\/phone-inputs\.js\?v=12/);
