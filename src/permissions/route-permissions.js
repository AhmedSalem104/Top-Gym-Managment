...
const ROUTE_PERMISSION_RULES = Object.freeze([
    ...
    { pattern: /^\/saas\/payment-proofs\/\d+\/file$/, methods: ['GET'], ownerOnly: true, all: [PERMISSIONS.SAAS_SUBSCRIPTION_READ] },
    ...
    { pattern: /^\/trainer\/goals$/, methods: ['GET'], all: [PERMISSIONS.COACHING_READ] },
    { pattern: /^\/trainer\/goals$/, methods: ['POST'], all: [PERMISSIONS.COACHING_CREATE] },
    { pattern: /^\/trainer\/goals\/\d+$/, methods: ['PATCH', 'PUT'], all: [PERMISSIONS.COACHING_UPDATE] },
    { pattern: /^\/trainer\/goals\/\d+\/status$/, methods: ['PATCH', 'POST'], all: [PERMISSIONS.COACHING_UPDATE] },
    { pattern: /^\/trainer\/goals\/\d+$/, methods: ['DELETE'], all: [PERMISSIONS.COACHING_DELETE] },
    { pattern: /^\/trainer\/notifications$/, methods: ['GET'], all: [PERMISSIONS.COACHING_READ] },
    { pattern: /^\/trainer\/tasks$/, methods: ['GET'], all: [PERMISSIONS.COACHING_READ] },
    { pattern: /^\/trainer\/tasks$/, methods: ['POST'], all: [PERMISSIONS.COACHING_CREATE] },
    { pattern: /^\/trainer\/tasks\/\d+$/, methods: ['PATCH', 'PUT'], all: [PERMISSIONS.COACHING_UPDATE] },
    { pattern: /^\/trainer\/tasks\/\d+\/dismiss$/, methods: ['POST'], all: [PERMISSIONS.COACHING_UPDATE] },
    { pattern: /^\/trainer\/templates$/, methods: ['GET'], all: [PERMISSIONS.COACHING_READ] },
    { pattern: /^\/trainer\/templates$/, methods: ['POST'], all: [PERMISSIONS.COACHING_CREATE] },
    { pattern: /^\/trainer\/templates\/\d+$/, methods: ['PATCH', 'PUT'], all: [PERMISSIONS.COACHING_UPDATE] },
    { pattern: /^\/trainer\/templates\/\d+\/instantiate$/, methods: ['POST'], all: [PERMISSIONS.COACHING_CREATE] },
