...
function registerBackupRoutes(app, { backupService, asyncRoute, isAuthorizedCronRequest }) {
    const controller = createBackupController({ backupService, isAuthorizedCronRequest });
